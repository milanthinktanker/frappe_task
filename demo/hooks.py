...
# }
website_route_rules = [
    {'from_route': '/customers1', 'to_route': '/customers1/customers1'},
    {"from_route": "/blogs", "to_route": "social/social"},
    {"from_route": "/blogs/<route>", "to_route": "social/blog_detail"}
    ]
doc_events = {
    "App User": {
        "before_insert": "social_media.social_media.doctype.app_user.app_user.before_insert"
    }
}
